...
def main() -> None:
    ...
    parser.add_argument('-O', '--originium-ore', type=float, default=540.0, help='Originium Ore supply, in items/min')
    parser.add_argument('-F', '--ferrium-ore', type=float, default=120.0, help='Ferrium Ore supply, in items/min')
    parser.add_argument('-C', '--cuprium-ore', type=float, default=420.0, help='Cuprium Ore supply, in items/min')
    parser.add_argument('-I', '--inergen', type=float, default=460.0, help='Inergen supply, in items/min')
    parser.add_argument('-X', '--xiragen', type=float, default=100.0, help='Xiragen supply, in items/min')
    parser.add_argument('-T', '--test-area-max-multiples', type=float, default=0.0, help='Cap on the Test Area Purification Node recipe (30 Sewage -> 1 Xircon Effluent). 0 (the default) disables it entirely. 12 is the true in-game value.')

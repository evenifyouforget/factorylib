...
Total upgrades cost: 1.7M $ (Wuling Stock Bill)
...
Inergen: 0/min → at least 260/min
Xiragen: 0/min → 30/min
# New Materials
Inergen (gas)
...
Forge of the Sky: 2 Stabilized Carbon + 1 Water --> 1 Xiranite (every 2 seconds)
Forge of the Sky: 10 Xiranite + 5 Xircon Effluent --> 1 Heavy Xiranite (every 10 seconds)

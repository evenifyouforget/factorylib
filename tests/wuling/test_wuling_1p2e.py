...
from ._helpers import make_formula, snap_result
...
def test_1p2e_full():
    ...
    assert np.allclose(
        best.formula_rates,
        [8, 393 / 73, 59 / 24, 0, 13 / 24, 2, 11 / 12, 0, 1350 / 73, 0, 393 / 292, 410 / 73],
    )
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [8, 393 / 73, 59 / 24, 0, 13 / 24, 2, 0, 0, 1350 / 73, 110, 393 / 292, 410 / 73],
            [0, 0, 0, 0, 0, 0, 0, 0],
            205129 / 146,
        ),
        (
        ...
        (
            ...
            [8, 4729 / 876, 59 / 24, 0, 0, 2, 2, 13 / 96, 2635 / 146, 0, 4729 / 3504, 2955 / 584],
            [0, 0, 0, 0, 0, 0, 0, 0],
            103335 / 73,
        ),
        (
        ...
        (
            ...
            [8, 573 / 88, 59 / 24, 0, 13 / 24, 307 / 176, 11 / 12, 0, 0, 0, 0, 395 / 88],
